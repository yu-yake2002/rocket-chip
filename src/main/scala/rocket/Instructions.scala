...
object Instructions {
  ...
  def MACQUIRE           = BitPat("b1010000??????????000000000101011")
  def MAX                = BitPat("b0000101??????????110?????0110011")
  def MAXU               = BitPat("b0000101??????????111?????0110011")
  def MFMACC_D           = BitPat("b000010000???11???00011???0101011")
  def MFMACC_D_S         = BitPat("b000010000???10???00011???0101011")
  def MFMACC_H           = BitPat("b000010000???01???00001???0101011")
  def MFMACC_BF16_E4     = BitPat("b000010101???00???00001???0101011")
  def MFMACC_BF16_E5     = BitPat("b000010100???00???00001???0101011")
  def MFMACC_H_E4        = BitPat("b000010001???00???00001???0101011")
  def MFMACC_H_E5        = BitPat("b000010000???00???00001???0101011")
  def MFMACC_S           = BitPat("b000010000???10???00010???0101011")
  def MFMACC_S_BF16      = BitPat("b000010001???01???00010???0101011")
  def MFMACC_S_E4        = BitPat("b000010001???00???00010???0101011")
  def MFMACC_S_E5        = BitPat("b000010000???00???00010???0101011")
  def MFMACC_S_H         = BitPat("b000010000???01???00010???0101011")
  def MFMACC_S_TF32      = BitPat("b000010001???10???00010???0101011")
  def MLAE16             = BitPat("b0000010??????????00001???0101011")
  def MLAE32             = BitPat("b0000010??????????00010???0101011")
  def MLAE64             = BitPat("b0000010??????????00011???0101011")
  def MLAE8              = BitPat("b0000010??????????00000???0101011")
  def MLATE16            = BitPat("b0100010??????????00001???0101011")
  def MLATE32            = BitPat("b0100010??????????00010???0101011")
  def MLATE64            = BitPat("b0100010??????????00011???0101011")
  def MLATE8             = BitPat("b0100010??????????00000???0101011")
  def MLBE16             = BitPat("b0001010??????????00001???0101011")
  def MLBE32             = BitPat("b0001010??????????00010???0101011")
  def MLBE64             = BitPat("b0001010??????????00011???0101011")
  def MLBE8              = BitPat("b0001010??????????00000???0101011")
  def MLBTE16            = BitPat("b0101010??????????00001???0101011")
  def MLBTE32            = BitPat("b0101010??????????00010???0101011")
  def MLBTE64            = BitPat("b0101010??????????00011???0101011")
  def MLBTE8             = BitPat("b0101010??????????00000???0101011")
  def MLCE16             = BitPat("b0010010??????????00001???0101011")
  def MLCE32             = BitPat("b0010010??????????00010???0101011")
  def MLCE64             = BitPat("b0010010??????????00011???0101011")
  def MLCE8              = BitPat("b0010010??????????00000???0101011")
  def MLCTE16            = BitPat("b0110010??????????00001???0101011")
  def MLCTE32            = BitPat("b0110010??????????00010???0101011")
  def MLCTE64            = BitPat("b0110010??????????00011???0101011")
  def MLCTE8             = BitPat("b0110010??????????00000???0101011")
  def MLME16             = BitPat("b001101000000?????00001???0101011")
  def MLME32             = BitPat("b001101000000?????00010???0101011")
  def MLME64             = BitPat("b001101000000?????00011???0101011")
  def MLME8              = BitPat("b001101000000?????00000???0101011")
  def MMACC_D_H          = BitPat("b000110011???01???00011???0101011")
  def MMACC_W_B          = BitPat("b000110011???00???00010???0101011")
  def MMACC_W_BP         = BitPat("b001010011???00???00010???0101011")
  def MMACCSU_D_H        = BitPat("b000110010???01???00011???0101011")
  def MMACCSU_W_B        = BitPat("b000110010???00???00010???0101011")
  def MMACCU_D_H         = BitPat("b000110000???01???00011???0101011")
  def MMACCU_W_B         = BitPat("b000110000???00???00010???0101011")
  def MMACCU_W_BP        = BitPat("b001010000???00???00010???0101011")
  def MMACCUS_D_H        = BitPat("b000110001???01???00011???0101011")
  def MMACCUS_W_B        = BitPat("b000110001???00???00010???0101011")
  ...
  def MRELEASE           = BitPat("b1001000?????00000000000000101011")
  def MRET               = BitPat("b00110000001000000000000001110011")
  def MSAE16             = BitPat("b0000011??????????00001???0101011")
  def MSAE32             = BitPat("b0000011??????????00010???0101011")
  def MSAE64             = BitPat("b0000011??????????00011???0101011")
  def MSAE8              = BitPat("b0000011??????????00000???0101011")
  def MSATE16            = BitPat("b0100011??????????00001???0101011")
  def MSATE32            = BitPat("b0100011??????????00010???0101011")
  def MSATE64            = BitPat("b0100011??????????00011???0101011")
  def MSATE8             = BitPat("b0100011??????????00000???0101011")
  def MSBE16             = BitPat("b0001011??????????00001???0101011")
  def MSBE32             = BitPat("b0001011??????????00010???0101011")
  def MSBE64             = BitPat("b0001011??????????00011???0101011")
  def MSBE8              = BitPat("b0001011??????????00000???0101011")
  def MSBTE16            = BitPat("b0101011??????????00001???0101011")
  def MSBTE32            = BitPat("b0101011??????????00010???0101011")
  def MSBTE64            = BitPat("b0101011??????????00011???0101011")
  def MSBTE8             = BitPat("b0101011??????????00000???0101011")
  def MSCE16             = BitPat("b0010011??????????00001???0101011")
  def MSCE32             = BitPat("b0010011??????????00010???0101011")
  def MSCE64             = BitPat("b0010011??????????00011???0101011")
  def MSCE8              = BitPat("b0010011??????????00000???0101011")
  def MSCTE16            = BitPat("b0110011??????????00001???0101011")
  def MSCTE32            = BitPat("b0110011??????????00010???0101011")
  def MSCTE64            = BitPat("b0110011??????????00011???0101011")
  def MSCTE8             = BitPat("b0110011??????????00000???0101011")
  def MSETTILEM          = BitPat("b0010001??????????000000000101011")
  def MSETTILEMI         = BitPat("b0010000??????????000000000101011")
  def MSETTILEN          = BitPat("b0011001??????????000000000101011")
  def MSETTILENI         = BitPat("b0011000??????????000000000101011")
  def MSETTILEK          = BitPat("b0001001??????????000000000101011")
  def MSETTILEKI         = BitPat("b0001000??????????000000000101011")
  def MSME16             = BitPat("b001101100000?????00001???0101011")
  def MSME32             = BitPat("b001101100000?????00010???0101011")
  def MSME64             = BitPat("b001101100000?????00011???0101011")
  def MSME8              = BitPat("b001101100000?????00000???0101011")
  def MSYNCRESET         = BitPat("b1000000?????00000000000000101011")
  def MUL                = BitPat("b0000001??????????000?????0110011")
  def MULH               = BitPat("b0000001??????????001?????0110011")
  def MULHSU             = BitPat("b0000001??????????010?????0110011")
  def MULHU              = BitPat("b0000001??????????011?????0110011")
  def MULW               = BitPat("b0000001??????????000?????0111011")
  def MZERO              = BitPat("b0000110000000000000000???0101011")
  def MZERO2R            = BitPat("b0000110010000000000000???0101011")
  def MZERO4R            = BitPat("b0000110110000000000000???0101011")
  def MZERO8R            = BitPat("b0000111110000000000000???0101011")
  ...
  def PMMACC_W_B         = BitPat("b000110111???00???00010???0101011")
  def PMMACCSU_W_B       = BitPat("b000110110???00???00010???0101011")
  def PMMACCU_W_B        = BitPat("b000110100???00???00010???0101011")
  def PMMACCUS_W_B       = BitPat("b000110101???00???00010???0101011")
