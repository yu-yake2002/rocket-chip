...
object Instructions {
  ...
  def MFMVE16_T_X        = BitPat("b0001101??????????001?????1110111")
  def MFMVE16_X_T        = BitPat("b0001100??????????001?????1110111")
  def MFMVE32_A_F        = BitPat("b0001101??????????110?????1110111")
  def MFMVE32_F_A        = BitPat("b0001100??????????110?????1110111")
  def MFMVE32_T_X        = BitPat("b0001101??????????010?????1110111")
  def MFMVE32_X_T        = BitPat("b0001100??????????010?????1110111")
  def MFMVE64_A_F        = BitPat("b0001101??????????111?????1110111")
  def MFMVE64_F_A        = BitPat("b0001100??????????111?????1110111")
  def MFMVE64_T_X        = BitPat("b0001101??????????011?????1110111")
  def MFMVE64_X_T        = BitPat("b0001100??????????011?????1110111")
  def MFMVE8_A_F         = BitPat("b0001101??????????100?????1110111")
  def MFMVE8_F_A         = BitPat("b0001100??????????100?????1110111")
  def MFMVE8_T_X         = BitPat("b0001101??????????000?????1110111")
  def MFMVE8_X_T         = BitPat("b0001100??????????000?????1110111")
